...
<head>
    ...
    <meta property="og:description" content="Salesforce consulting developing SPA through Lightning Aura and AngularJS by Minuscule Technologies to help enterprises implement CRM solutions, customize, integrate, and develop using salesforce.com and the Force.com platform, Angular JS"/>
    <meta property="og:url" content="http://www.minusculetechnologies.com/salesforce-SPAs-Aura-or-AngularJS.html" />
    <meta charset="utf-8">
    <?php
        include "script.php";
    ?>
...
<body>
    ...
    <!--========== PROMO BLOCK ==========-->
    <img src="img/1920x1080/spa.jpg" class="img-responsive res">
    <!--========== END PROMO BLOCK ==========-->
    <!--========== PAGE CONTENT ==========-->
				...
				<div class="skill-wrap clearfix">
					<div class="wow animated" style="visibility: visible;">
						<p class="lead fontSizeChange">
							...
							<br><br> 
							While looking at the best possible options for creating Single Page Applications (SPAs) in Salesforce, we evaluated <b>Aura</b> and <b>AngularJS</b>. We have noticed that there are pros and cons in both.
							<br> <br>
							...
							<br> <br>
							On the other hand, Superheroic JavaScript MVW Framework AngularJs is still a superior framework for building extraordinary Single Page Applications as it supports <i>Two-way data binding</i> and <i>Dependency injection</i>.
							<br> <br>
