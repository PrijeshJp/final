...
<body>
    ...
    <div class="container blogpad">
        ...
        <ul class="keyFeatureList wow fadeInDown animated" data-wow-delay="600ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 600ms; animation-name: fadeInDown;">
            ...
            <li><i class="fa fa-hand-o-right" aria-hidden="true"></i> OBIEE Migration</li>
            <li><i class="fa fa-hand-o-right" aria-hidden="true"></i> OBIEE Administration</li>
            <li><i class="fa fa-hand-o-right" aria-hidden="true"></i> OBIEE Consulting</li>
        </ul>
        <br>
        <!--/.our-skill--><!-- our-team -->
        <!--section-->
