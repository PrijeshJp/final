                                        ...
                                        <div class="col-sm-6 col-md-4 curPoint">
                                            <div class="media services-wrap wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p>When developing functionality in force.com, we always give priority to declarative features (both in classic and lightning) rather than programmatic tools (code). However, we could utilize force.com programming tools to complete complex requirement based on client needs.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-4 curPoint">
